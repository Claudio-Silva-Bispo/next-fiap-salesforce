      ...
      <section className="py-6 bg-terceira text-gray-900 min-h-[80vh] flex justify-center items-center" id="contact">
          <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:pt-20">
              ...
              <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                  ...
                  <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-primeira text-gray-50 focus:ring-violet-600 hover:ring-violet-600 w-full">Enviar</button>
              </form>
