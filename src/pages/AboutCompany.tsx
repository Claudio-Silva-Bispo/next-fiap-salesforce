...
export default function AboutCompany() {
    return (
        <div className="bg-primeira py-12" id='sobre-empresa'>
            <div className="container mx-auto px-6 lg:px-20 mt-20">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                    ...
                    <div className='flex flex-col justify-center items-center gap-10'>
                        ...
                        <div>
                            <h1 className="text-5xl font-bold mb-3 text-gray-700 uppercase">Sobre a empresa</h1>
                        ...
                        <div className="flex flex-col justify-center text-start lg:text-left">
                            <h2 className="text-6xl font-bold text-gray-700 mb-3">Missão</h2>
                        ...
                        <div className="text-start">
                            <h2 className="text-6xl font-bold text-gray-700 mb-3">Visão</h2>
                    ...
                    <div className="flex flex-col justify-center rounded-md">
                        <img src='/assets/AboutCompany/imagem2.jpg' alt="Foto da equipe aqui" className='min-h-[80vh]'/>
                    </div>
