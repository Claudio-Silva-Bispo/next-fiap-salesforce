        ...
        <div className="relative w-full min-h-screen flex flex-col-reverse md:flex-row text-black">
            ...
            <div className="flex flex-col max-w-3xl mx-auto p-6 sm:p-10 md:p-5   md:w-full xl:w-[60%] bg-[#93BF4C] md:bg-[#679F20] pt-10 md:pt-0 pb-20 md:pb-0 justify-center">
                    <div className="space-y-2">
                        <h2 className="text-2xl md:text-4xl xl:text-6xl text-left font-bold uppercase">
                            Quem somos
                        </h2>
                    ...
                    <div className="flex flex-col gap-5 text-left text-xl md:text-lg lg:text-xl">
                        ...
                        <h2 className="text-2xl md:text-2xl xl:text-4xl uppercase font-bold">O que Buscamos?</h2>
