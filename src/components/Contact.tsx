            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:pt-20">
                ...
                <div>
                    ...
                    <div className="py-6 md:py-0 md:px-6 flex flex-col justify-center">
                        ...
                        <h1 className="text-4xl md:text-3xl font-bold text-white mb-5">Dados para contato</h1>
                            ...
                            <div className="flex flex-col justify-start lg:pt-5">
                                <div className="flex justify-start space-x-2 gap-5 md:space-x-4 pt-3">
                                    ...
                                    <a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center justify-center w-12 h-12 rounded-full sm:w-18 sm:h-18 bg-primeira hover:bg-quarta text-gray-50">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="w-5 h-5 md:w-6 md:h-6 ">
                                    ...
                                    <a rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center justify-center w-12 h-12 rounded-full sm:w-18 sm:h-18 bg-primeira hover:bg-quarta text-gray-50">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 md:w-6 md:h-6">
                ...
                <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    ...
                    <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-primeira text-gray-50 focus:ring-violet-600 hover:ring-violet-600 w-full">Entre em contato</button>
                </form>
