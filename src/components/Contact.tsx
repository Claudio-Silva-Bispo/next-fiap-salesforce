            ...
            <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:pt-20">
                        ...
                        <div className="flex flex-col justify-start lg:pt-10">
                            <div className="flex justify-start space-x-2 md:space-x-4">
                                ...
                                <a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center justify-center w-12 h-12 rounded-full sm:w-18 sm:h-18 bg-primeira hover:bg-quarta text-gray-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" className="w-5 h-5 md:w-12 md:h-12">
                                ...
                                <a rel="noopener noreferrer" href="#" title="Pinterest" className="flex items-center justify-center w-12 h-12 rounded-full sm:w-18 sm:h-18 bg-primeira hover:bg-quarta text-gray-50">
                                ...
                                <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-12 h-12 rounded-full sm:w-18 sm:h-18 bg-primeira hover:bg-quarta text-gray-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 md:w-8 md:h-8">
                ...
                <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                    <label className="block">
                        ...
                        <input type="text" placeholder="digite seu nome" className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-violet-600 bg-gray-100 p-3 mt-3" />
                    </label>
                    <label className="block">
                    ...
                    <button type="button" className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-quarta text-gray-50 focus:ring-violet-600 hover:ring-violet-600 w-full">Entrar em contato</button>
                </form>
            </div>
        </section>
