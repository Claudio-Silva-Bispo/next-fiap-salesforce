...
export default function Service(){
    return (
        <section className="bg-terceira text-gray-800">
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 pt-10 md:pt-28">

                <div>
                    <h2 className="text-3xl md:text-5xl font-bold leading-10 md:leading-relaxed mb-16 md:mb-0">Conheça os serviços
                        <span className="text-white"> feitos</span> de forma <span className="text-white">personalizada</span> para você.
                    </h2>
                </div>
                ...
                <div rel="noopener noreferrer" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-50 rounded-md">
                    ...
                    <div className="p-6 space-y-2 lg:col-span-5">
                        <h3 className="text-2xl font-semibold sm:text-4xl group-hover:underline group-focus:underline mb-5">Regular Cleaning</h3>
                ...
                <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 rounded-md">
                    <div rel="noopener noreferrer" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-gray-50 rounded-md">
                        ...
                        <div className="p-6 space-y-2">
                            <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline mb-5">Serviços Comerciais</h3>
                    ...
                    <div rel="noopener noreferrer" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-gray-50 rounded-md">
                        ...
                        <div className="p-6 space-y-2">
                            <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline mb-5">Move In / Move Out</h3>
                    ...
                    <div rel="noopener noreferrer" className="max-w-sm mx-auto group hover:no-underline focus:no-underline bg-gray-50 rounded-md">
                        ...
                        <div className="p-6 space-y-2">
                            <h3 className="text-2xl font-semibold group-hover:underline group-focus:underline mb-5">Deep Cleaning</h3>
